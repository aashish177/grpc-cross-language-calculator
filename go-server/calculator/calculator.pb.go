...
const file_calculator_proto_rawDesc = "" +
	...
	"\x01b\x18\x02 \x01(\x01R\x01b\"K\n" +
	"\x13CalculationResponse\x12\x16\n" +
	"\x06result\x18\x01 \x01(\x01R\x06result\x12\x1c\n" +
	"\toperation\x18\x02 \x01(\tR\toperation2\xb9\x02\n" +
	"\n" +
	"Calculator\x12F\n" +
	"\x03Add\x12\x1e.calculator.CalculationRequest\x1a\x1f.calculator.CalculationResponse\x12K\n" +
	"\bSubtract\x12\x1e.calculator.CalculationRequest\x1a\x1f.calculator.CalculationResponse\x12K\n" +
	"\bMultiply\x12\x1e.calculator.CalculationRequest\x1a\x1f.calculator.CalculationResponse\x12I\n" +
	"\x06Divide\x12\x1e.calculator.CalculationRequest\x1a\x1f.calculator.CalculationResponseB\x0eZ\f./calculatorb\x06proto3"
